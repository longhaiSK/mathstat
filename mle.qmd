...
2. **Derivations via Moments of Sufficient Statistics**
   ...
   The details of procedure for deriving the above formula for score and fisher information matrix using scalar derivative is given in @sec-poisson-score-fisher. 
...
## Appendix: Derivation of Score and Information in Poisson Regression {#sec-poisson-score-fisher}
